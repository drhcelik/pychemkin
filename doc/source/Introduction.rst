...
What is **PyChemkin**? **PyChemkin**, in its core, inherites all Chemkin functionalities. However, in addition to providing a collection of Pythonic interfaces to Chemkin utilties and reactor models, **PyChemkin** adopts a few new concenpts to deliver enhanced user experiences within the Python framework. 
